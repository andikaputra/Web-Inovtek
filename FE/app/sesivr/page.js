...
function SesiCRUD() {
 ...
 const [sesiList, setSesiList] = useState([]);
  ...
  const apiUrl = `${process.env.apiUrl}/sesi/vr`;
  ...
  useEffect(() => {
    ...
    const storedLokasi = localStorage.getItem("lokasi_vr");
      ...
      <div className={`flex-1 ${isMenuOpen ? "ml-0" : "ml-0 md:ml-16"}`}>
        ...
        <div className="min-h-screen bg-gray-100 py-8 bg-cover bg-center">
          <div className="container mx-auto p-6 bg-white bg-opacity-90 rounded-lg shadow-lg">
            <h1 className="text-2xl font-bold text-center mb-6">VR log user play game</h1>
           ...
           {/* Form */}
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="mb-4">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      localStorage.setItem("kota_vr", e.target.value);
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      localStorage.setItem("lokasi_vr", e.target.value);
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4"> 
                ...
                <div className="mb-4">
                  ...
                  <select
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700"
                    value={formData.skenario || ""} // Ensure controlled value
                    onChange={(e) =>
                      setFormData({ ...formData, skenario: e.target.value })
                    }
                  >
            ...
            <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
              ...
              <div>
                <input
                  type="text"
                  placeholder="Cari berdasarkan No Sesi, Nama, Skenario, atau Lokasi"
              ...
              <tbody>
                {currentItems.map((sesi, index) => (
                  <tr key={sesi.id} className="border-t">
                    <td className="px-4 py-2 text-center">{firstItemIndex + index + 1}</td>
                    <td className="px-4 py-2">{sesi.no_sesi || "-"}</td>
                    <td className="px-4 py-2">{sesi.nama || "-"}</td>
                    <td className="px-4 py-2">{sesi.skenario  || "-"}</td>
